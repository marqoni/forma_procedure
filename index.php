...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Попис административних поступака</title>
...
?>
	<?php if(isset($_SESSION['user_info']) && is_array($_SESSION['user_info'])) { ?>
	    ...
	    <form id="login-form" class="login-form" name="form1">
	        ...
	        <div id="form-content">
	            <div class="welcome">
					<?php echo $_SESSION['user_info']['name']  ?>,  добро дошли. Молимо Вас да попуните формулар за попис административних поступака.  
                    <br /><br />
                    <?php echo $_SESSION['user_info']['content']  ?>
                    <br /><br />
                    <a href="index.php?ac=logout" style="color:#3ec038">Изађи</a>
				</div>	
	        </div>
	...
	<?php } else { ?>
	    <form id="login-form" class="login-form" name="form1" method="post" action="index.php">
	        ...
	        <div class="h1">Попис административних процедура</div>
	        <div id="form-content">
	            <div class="group">
	                <label for="email">Налог</label>
	           ...
	           <div class="group">
	            ...
	            <div class="group submit">
	                ...
	                <div><input name="submit" type="submit" value="Потврди"/></div>
	            </div>
	        </div>
